# Generated by Django 4.1.7 on 2023-03-08 19:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipeline_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arguments', to='tasks_pipeline.task')),
            ],
        ),
        migrations.CreateModel(
            name='PipelineTask',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('New', 'new'), ('Running', 'running'), ('Failed', 'failed')], max_length=50)),
                ('pipeline_task_execution', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasks_pipeline.pipelinetask')),
            ],
        ),
    ]
